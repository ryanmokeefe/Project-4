...
//            // get the third person character ( this should never be null due to require component )
        ...
        private void Update()
        {
			...
			m_Move = new Vector3 (moveHorizontal, 0.0f, moveVertical);
        ...
        private void FixedUpdate()
        {
			...
			// If the player's m_Move vector does not equal zero...
			if (m_Move != Vector3.zero) {

				// ...then create a target rotation based on the m_Move vector...
				Quaternion targetRotation = Quaternion.LookRotation(m_Move, Vector3.up);
